...
// R squared calc
        ...
        for (Car car : cars) {
            double x = getAttributeValue(car, xAttribute);
            double y = getAttributeValue(car, yAttribute);
            double predictedY = regressionSlope * x + regressionIntercept;
            ssTotal += Math.pow(y - (sumY / n), 2);
    ...
    public void printRegressionStatistics() {
        System.out.println("Regression Statistics:");
        System.out.println("Slope: " + regressionSlope);
        System.out.println("Intercept: " + regressionIntercept);
